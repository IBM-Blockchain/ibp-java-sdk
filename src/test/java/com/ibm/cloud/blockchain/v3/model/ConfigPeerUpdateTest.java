...
/**
 * Unit test class for the ConfigPeerUpdate model.
 */
public class ConfigPeerUpdateTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testConfigPeerUpdate() throws Throwable {
    ...
    String json = TestUtilities.serialize(configPeerUpdateModel);

    ConfigPeerUpdate configPeerUpdateModelNew = TestUtilities.deserialize(json, ConfigPeerUpdate.class);
    assertTrue(configPeerUpdateModelNew instanceof ConfigPeerUpdate);
    assertEquals(configPeerUpdateModelNew.peer().toString(), configPeerUpdatePeerModel.toString());
    assertEquals(configPeerUpdateModelNew.chaincode().toString(), configPeerChaincodeModel.toString());
    assertEquals(configPeerUpdateModelNew.metrics().toString(), metricsModel.toString());
  }
}