...
/**
 * Unit test class for the UpdateCaOptions model.
 */
public class UpdateCaOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateCaOptions() throws Throwable {
    ...
    UpdateCaOptions updateCaOptionsModel = new UpdateCaOptions.Builder()
      ...
      .zone("-")
      .build();
    assertEquals(updateCaOptionsModel.id(), "testString");
    assertEquals(updateCaOptionsModel.configOverride(), updateCaBodyConfigOverrideModel);
    assertEquals(updateCaOptionsModel.replicas(), Double.valueOf("1"));
    assertEquals(updateCaOptionsModel.resources(), updateCaBodyResourcesModel);
    assertEquals(updateCaOptionsModel.version(), "1.4.6-1");
    assertEquals(updateCaOptionsModel.zone(), "-");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateCaOptionsError() throws Throwable {
    new UpdateCaOptions.Builder().build();
  }
