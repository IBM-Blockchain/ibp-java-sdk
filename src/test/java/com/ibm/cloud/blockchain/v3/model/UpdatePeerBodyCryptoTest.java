...
/**
 * Unit test class for the UpdatePeerBodyCrypto model.
 */
public class UpdatePeerBodyCryptoTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdatePeerBodyCrypto() throws Throwable {
    ...
    String json = TestUtilities.serialize(updatePeerBodyCryptoModel);

    UpdatePeerBodyCrypto updatePeerBodyCryptoModelNew = TestUtilities.deserialize(json, UpdatePeerBodyCrypto.class);
    assertTrue(updatePeerBodyCryptoModelNew instanceof UpdatePeerBodyCrypto);
    assertEquals(updatePeerBodyCryptoModelNew.enrollment().toString(), updateEnrollmentCryptoFieldModel.toString());
    assertEquals(updatePeerBodyCryptoModelNew.msp().toString(), updateMspCryptoFieldModel.toString());
  }
}