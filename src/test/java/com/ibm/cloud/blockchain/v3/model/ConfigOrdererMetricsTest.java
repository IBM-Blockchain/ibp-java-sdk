...
/**
 * Unit test class for the ConfigOrdererMetrics model.
 */
public class ConfigOrdererMetricsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testConfigOrdererMetrics() throws Throwable {
    ...
    String json = TestUtilities.serialize(configOrdererMetricsModel);

    ConfigOrdererMetrics configOrdererMetricsModelNew = TestUtilities.deserialize(json, ConfigOrdererMetrics.class);
    assertTrue(configOrdererMetricsModelNew instanceof ConfigOrdererMetrics);
    assertEquals(configOrdererMetricsModelNew.provider(), "disabled");
    assertEquals(configOrdererMetricsModelNew.statsd().toString(), configOrdererMetricsStatsdModel.toString());
  }
}