...
/**
 * Unit test class for the UpdateMspCryptoFieldCa model.
 */
public class UpdateMspCryptoFieldCaTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateMspCryptoFieldCa() throws Throwable {
    ...
    String json = TestUtilities.serialize(updateMspCryptoFieldCaModel);

    UpdateMspCryptoFieldCa updateMspCryptoFieldCaModelNew = TestUtilities.deserialize(json, UpdateMspCryptoFieldCa.class);
    assertTrue(updateMspCryptoFieldCaModelNew instanceof UpdateMspCryptoFieldCa);
  }
}