...
/**
 * Unit test class for the MspCryptoFieldComponent model.
 */
public class MspCryptoFieldComponentTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testMspCryptoFieldComponent() throws Throwable {
    ...
    String json = TestUtilities.serialize(mspCryptoFieldComponentModel);

    MspCryptoFieldComponent mspCryptoFieldComponentModelNew = TestUtilities.deserialize(json, MspCryptoFieldComponent.class);
    assertTrue(mspCryptoFieldComponentModelNew instanceof MspCryptoFieldComponent);
    assertEquals(mspCryptoFieldComponentModelNew.tlsCert(), "LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCkNlcnQgZGF0YSB3b3VsZCBiZSBoZXJlIGlmIHRoaXMgd2FzIHJlYWwKLS0tLS1FTkQgQ0VSVElGSUNBVEUtLS0tLQo=");
    assertEquals(mspCryptoFieldComponentModelNew.ecert(), "LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCkNlcnQgZGF0YSB3b3VsZCBiZSBoZXJlIGlmIHRoaXMgd2FzIHJlYWwKLS0tLS1FTkQgQ0VSVElGSUNBVEUtLS0tLQo=");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testMspCryptoFieldComponentError() throws Throwable {
    new MspCryptoFieldComponent.Builder().build();
  }
