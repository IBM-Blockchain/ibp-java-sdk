...
/**
 * Unit test class for the Bccsp model.
 */
public class BccspTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testBccsp() throws Throwable {
    ...
    String json = TestUtilities.serialize(bccspModel);

    Bccsp bccspModelNew = TestUtilities.deserialize(json, Bccsp.class);
    assertTrue(bccspModelNew instanceof Bccsp);
    assertEquals(bccspModelNew.xDefault(), "SW");
    assertEquals(bccspModelNew.sw().toString(), bccspSwModel.toString());
    assertEquals(bccspModelNew.pkcS11().toString(), bccspPkcS11Model.toString());
  }
}