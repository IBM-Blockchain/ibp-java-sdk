...
/**
 * Unit test class for the OrdererActionOptions model.
 */
public class OrdererActionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testOrdererActionOptions() throws Throwable {
    ...
    OrdererActionOptions ordererActionOptionsModel = new OrdererActionOptions.Builder()
      ...
      .build();
    assertEquals(ordererActionOptionsModel.id(), "testString");
    assertEquals(ordererActionOptionsModel.restart(), Boolean.valueOf(true));
    assertEquals(ordererActionOptionsModel.reenroll(), actionReenrollModel);
    assertEquals(ordererActionOptionsModel.enroll(), actionEnrollModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testOrdererActionOptionsError() throws Throwable {
    new OrdererActionOptions.Builder().build();
  }
