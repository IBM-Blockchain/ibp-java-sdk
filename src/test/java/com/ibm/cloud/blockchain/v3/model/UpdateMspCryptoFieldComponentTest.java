...
/**
 * Unit test class for the UpdateMspCryptoFieldComponent model.
 */
public class UpdateMspCryptoFieldComponentTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateMspCryptoFieldComponent() throws Throwable {
    ...
    String json = TestUtilities.serialize(updateMspCryptoFieldComponentModel);

    UpdateMspCryptoFieldComponent updateMspCryptoFieldComponentModelNew = TestUtilities.deserialize(json, UpdateMspCryptoFieldComponent.class);
    assertTrue(updateMspCryptoFieldComponentModelNew instanceof UpdateMspCryptoFieldComponent);
    assertEquals(updateMspCryptoFieldComponentModelNew.ekey(), "testString");
    assertEquals(updateMspCryptoFieldComponentModelNew.ecert(), "LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCkNlcnQgZGF0YSB3b3VsZCBiZSBoZXJlIGlmIHRoaXMgd2FzIHJlYWwKLS0tLS1FTkQgQ0VSVElGSUNBVEUtLS0tLQo=");
    assertEquals(updateMspCryptoFieldComponentModelNew.tlsKey(), "testString");
    assertEquals(updateMspCryptoFieldComponentModelNew.tlsCert(), "LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCkNlcnQgZGF0YSB3b3VsZCBiZSBoZXJlIGlmIHRoaXMgd2FzIHJlYWwKLS0tLS1FTkQgQ0VSVElGSUNBVEUtLS0tLQo=");
    assertEquals(updateMspCryptoFieldComponentModelNew.clientAuth().toString(), clientAuthModel.toString());
  }
}