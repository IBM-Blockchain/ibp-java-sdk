...
/**
 * Unit test class for the ConfigCACfg model.
 */
public class ConfigCACfgTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testConfigCACfg() throws Throwable {
    ...
    String json = TestUtilities.serialize(configCaCfgModel);

    ConfigCACfg configCaCfgModelNew = TestUtilities.deserialize(json, ConfigCACfg.class);
    assertTrue(configCaCfgModelNew instanceof ConfigCACfg);
    assertEquals(configCaCfgModelNew.identities().toString(), configCaCfgIdentitiesModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testConfigCACfgError() throws Throwable {
    new ConfigCACfg.Builder().build();
  }
