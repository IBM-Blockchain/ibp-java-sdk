...
/**
 * Unit test class for the ConfigCASigning model.
 */
public class ConfigCASigningTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testConfigCASigning() throws Throwable {
    ...
    String json = TestUtilities.serialize(configCaSigningModel);

    ConfigCASigning configCaSigningModelNew = TestUtilities.deserialize(json, ConfigCASigning.class);
    assertTrue(configCaSigningModelNew instanceof ConfigCASigning);
    assertEquals(configCaSigningModelNew.xDefault().toString(), configCaSigningDefaultModel.toString());
    assertEquals(configCaSigningModelNew.profiles().toString(), configCaSigningProfilesModel.toString());
  }
}