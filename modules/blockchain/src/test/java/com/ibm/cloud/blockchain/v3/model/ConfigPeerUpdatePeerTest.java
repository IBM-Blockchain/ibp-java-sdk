...
/**
 * Unit test class for the ConfigPeerUpdatePeer model.
 */
public class ConfigPeerUpdatePeerTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testConfigPeerUpdatePeer() throws Throwable {
    ...
    String json = TestUtilities.serialize(configPeerUpdatePeerModel);

    ConfigPeerUpdatePeer configPeerUpdatePeerModelNew = TestUtilities.deserialize(json, ConfigPeerUpdatePeer.class);
    assertTrue(configPeerUpdatePeerModelNew instanceof ConfigPeerUpdatePeer);
    assertEquals(configPeerUpdatePeerModelNew.id(), "john-doe");
    assertEquals(configPeerUpdatePeerModelNew.networkId(), "dev");
    assertEquals(configPeerUpdatePeerModelNew.keepalive().toString(), configPeerKeepaliveModel.toString());
    assertEquals(configPeerUpdatePeerModelNew.gossip().toString(), configPeerGossipModel.toString());
    assertEquals(configPeerUpdatePeerModelNew.authentication().toString(), configPeerAuthenticationModel.toString());
    assertEquals(configPeerUpdatePeerModelNew.client().toString(), configPeerClientModel.toString());
    assertEquals(configPeerUpdatePeerModelNew.deliveryclient().toString(), configPeerDeliveryclientModel.toString());
    assertEquals(configPeerUpdatePeerModelNew.adminService().toString(), configPeerAdminServiceModel.toString());
    assertEquals(configPeerUpdatePeerModelNew.validatorPoolSize(), Double.valueOf("8"));
    assertEquals(configPeerUpdatePeerModelNew.discovery().toString(), configPeerDiscoveryModel.toString());
    assertEquals(configPeerUpdatePeerModelNew.limits().toString(), configPeerLimitsModel.toString());
  }
}