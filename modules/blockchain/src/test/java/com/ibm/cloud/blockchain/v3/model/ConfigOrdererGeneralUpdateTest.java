...
/**
 * Unit test class for the ConfigOrdererGeneralUpdate model.
 */
public class ConfigOrdererGeneralUpdateTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testConfigOrdererGeneralUpdate() throws Throwable {
    ...
    String json = TestUtilities.serialize(configOrdererGeneralUpdateModel);

    ConfigOrdererGeneralUpdate configOrdererGeneralUpdateModelNew = TestUtilities.deserialize(json, ConfigOrdererGeneralUpdate.class);
    assertTrue(configOrdererGeneralUpdateModelNew instanceof ConfigOrdererGeneralUpdate);
    assertEquals(configOrdererGeneralUpdateModelNew.keepalive().toString(), configOrdererKeepaliveModel.toString());
    assertEquals(configOrdererGeneralUpdateModelNew.authentication().toString(), configOrdererAuthenticationModel.toString());
  }
}