...
/**
 * Unit test class for the ConfigCASigningProfiles model.
 */
public class ConfigCASigningProfilesTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testConfigCASigningProfiles() throws Throwable {
    ...
    String json = TestUtilities.serialize(configCaSigningProfilesModel);

    ConfigCASigningProfiles configCaSigningProfilesModelNew = TestUtilities.deserialize(json, ConfigCASigningProfiles.class);
    assertTrue(configCaSigningProfilesModelNew instanceof ConfigCASigningProfiles);
    assertEquals(configCaSigningProfilesModelNew.ca().toString(), configCaSigningProfilesCaModel.toString());
    assertEquals(configCaSigningProfilesModelNew.tls().toString(), configCaSigningProfilesTlsModel.toString());
  }
}