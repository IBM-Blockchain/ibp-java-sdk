...
public class BlockchainIT extends SdkIntegrationTestBase {
    ...
    public void testGetComponent() throws Exception {
        try {
            GetComponentOptions getComponentOptions = new GetComponentOptions.Builder().id("testString")
    ...
    public void testCreateCa() throws Exception {
        try {
            ...
            IdentityAttrs identityAttrsModel = new IdentityAttrs.Builder().hfRegistrarRoles("*")
                    .hfRegistrarDelegateRoles("*").hfRevoker(true).hfIntermediateCa(true).hfGenCrl(true)
                    .hfRegistrarAttributes("*").hfAffiliationMgr(true).build();

            ConfigCARegistryIdentitiesItem configCaRegistryIdentitiesItemModel = new ConfigCARegistryIdentitiesItem.Builder()
                    .name("admin").pass("password").type("client").maxenrollments(Double.valueOf("-1"))
                    .affiliation("testString").attrs(identityAttrsModel).build();
            ...
            ConfigCACsrNamesItem configCaCsrNamesItemModel = new ConfigCACsrNamesItem.Builder().c("US")
                    .st("North Carolina").l("Raleigh").o("Hyperledger").ou("Fabric").build();

            ConfigCACsrCa configCaCsrCaModel = new ConfigCACsrCa.Builder().expiry("131400h")
                    .pathlength(Double.valueOf("0")).build();

            ConfigCACsr configCaCsrModel = new ConfigCACsr.Builder().cn("ca").keyrequest(configCaCsrKeyrequestModel)
                    .names(new java.util.ArrayList<ConfigCACsrNamesItem>(
                            java.util.Arrays.asList(configCaCsrNamesItemModel)))
                    .hosts(new java.util.ArrayList<String>(java.util.Arrays.asList("localhost"))).ca(configCaCsrCaModel)
                    .build();
            ...
            ConfigCASigningDefault configCaSigningDefaultModel = new ConfigCASigningDefault.Builder()
                    .usage(new java.util.ArrayList<String>(java.util.Arrays.asList("cert sign"))).expiry("8760h")
                    .build();
            ...
            ConfigCACreate configCaCreateModel = new ConfigCACreate.Builder().cors(configCaCorsModel).debug(false)
                    .crlsizelimit(Double.valueOf("512000")).tls(configCaTlsModel).ca(configCaCaModel)
                    .crl(configCaCrlModel).registry(configCaRegistryModel).db(configCaDbModel)
                    .affiliations(configCaAffiliationsModel).csr(configCaCsrModel).idemix(configCaIdemixModel)
                    .bccsp(bccspModel).intermediate(configCaIntermediateModel).cfg(configCaCfgModel)
                    .metrics(metricsModel).signing(configCaSigningModel).build();
            ...
            ResourceRequests resourceRequestsModel = new ResourceRequests.Builder().cpu("100m").memory("256MiB")
                    .build();
            ...
            CreateCaBodyResources createCaBodyResourcesModel = new CreateCaBodyResources.Builder()
                    .ca(resourceObjectModel).build();

            StorageObject storageObjectModel = new StorageObject.Builder().size("4GiB").xClass("default").build();

            CreateCaBodyStorage createCaBodyStorageModel = new CreateCaBodyStorage.Builder().ca(storageObjectModel)
                    .build();

            Hsm hsmModel = new Hsm.Builder().pkcs11endpoint("tcp://example.com:666").build();

            CreateCaOptions createCaOptions = new CreateCaOptions.Builder().displayName("My CA")
                    ...
                    .tags(new java.util.ArrayList<String>(java.util.Arrays.asList("fabric-ca"))).hsm(hsmModel)
                    .region("-").version("1.4.6-1").build();
    ...
    public void testImportCa() throws Exception {
        try {
            ...
            ImportCaOptions importCaOptions = new ImportCaOptions.Builder().displayName("Sample CA")
                    .apiUrl("https://n3a3ec3-myca.ibp.us-south.containers.appdomain.cloud:7054")
                    .msp(importCaBodyMspModel).location("ibmcloud")
    ...
    public void testUpdateCa() throws Exception {
        try {
            ...
            UpdateCaOptions updateCaOptions = new UpdateCaOptions.Builder().id("testString")
    ...
    public void testEditCa() throws Exception {
        try {
            EditCaOptions editCaOptions = new EditCaOptions.Builder().id("testString").displayName("My CA")
                    .apiUrl("https://n3a3ec3-myca.ibp.us-south.containers.appdomain.cloud:7054")
                    .operationsUrl("https://n3a3ec3-myca.ibp.us-south.containers.appdomain.cloud:9443").caName("ca")
                    .location("ibmcloud").tags(new java.util.ArrayList<String>(java.util.Arrays.asList("fabric-ca")))
                    .build();
    ...
    public void testCaAction() throws Exception {
        try {
            ...
            CaActionOptions caActionOptions = new CaActionOptions.Builder().id("testString").restart(true)
    ...
    public void testCreatePeer() throws Exception {
        try {
            ...
            CryptoObjectEnrollmentCa cryptoObjectEnrollmentCaModel = new CryptoObjectEnrollmentCa.Builder()
                    .host("n3a3ec3-myca.ibp.us-south.containers.appdomain.cloud").port(Double.valueOf("7054"))
                    .name("ca")
                    .tlsCert(
                            "LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCkNlcnQgZGF0YSB3b3VsZCBiZSBoZXJlIGlmIHRoaXMgd2FzIHJlYWwKLS0tLS1FTkQgQ0VSVElGSUNBVEUtLS0tLQo=")
            ...
            ConfigPeerKeepalive configPeerKeepaliveModel = new ConfigPeerKeepalive.Builder().minInterval("60s")
                    .client(configPeerKeepaliveClientModel).deliveryClient(configPeerKeepaliveDeliveryClientModel)
                    .build();
            ...
            ConfigPeerGossipPvtData configPeerGossipPvtDataModel = new ConfigPeerGossipPvtData.Builder()
                    .pullRetryThreshold("60s").transientstoreMaxBlockRetention(Double.valueOf("1000"))
                    .pushAckTimeout("3s").btlPullMargin(Double.valueOf("10")).reconcileBatchSize(Double.valueOf("10"))
                    .reconcileSleepInterval("1m").reconciliationEnabled(true)
                    .skipPullingInvalidTransactionsDuringCommit(false).implicitCollectionDisseminationPolicy(
            ...
            ConfigPeerGossip configPeerGossipModel = new ConfigPeerGossip.Builder().useLeaderElection(true)
                    .orgLeader(false).membershipTrackerInterval("5s").maxBlockCountToStore(Double.valueOf("100"))
                    .maxPropagationBurstLatency("10ms").maxPropagationBurstSize(Double.valueOf("10"))
                    .propagateIterations(Double.valueOf("3")).pullInterval("4s").pullPeerNum(Double.valueOf("3"))
                    .requestStateInfoInterval("4s").publishStateInfoInterval("4s").stateInfoRetentionInterval("0s")
                    .publishCertPeriod("10s").skipBlockVerification(false).dialTimeout("3s").connTimeout("2s")
                    .recvBuffSize(Double.valueOf("20")).sendBuffSize(Double.valueOf("200")).digestWaitTime("1s")
                    .requestWaitTime("1500ms").responseWaitTime("2s").aliveTimeInterval("5s")
                    .aliveExpirationTimeout("25s").reconnectInterval("25s").election(configPeerGossipElectionModel)
                    .pvtData(configPeerGossipPvtDataModel).state(configPeerGossipStateModel).build();

            ConfigPeerAuthentication configPeerAuthenticationModel = new ConfigPeerAuthentication.Builder()
                    .timewindow("15m").build();
            ...
            ConfigPeerDeliveryclientAddressOverridesItem configPeerDeliveryclientAddressOverridesItemModel = new ConfigPeerDeliveryclientAddressOverridesItem.Builder()
                    ...
                    .caCertsFile("my-data/cert.pem").build();
            ...
            ConfigPeerCreatePeer configPeerCreatePeerModel = new ConfigPeerCreatePeer.Builder().id("john-doe")
                    .networkId("dev").keepalive(configPeerKeepaliveModel).gossip(configPeerGossipModel)
                    .authentication(configPeerAuthenticationModel).bccsp(bccspModel).client(configPeerClientModel)
                    .deliveryclient(configPeerDeliveryclientModel).adminService(configPeerAdminServiceModel)
                    .validatorPoolSize(Double.valueOf("8")).discovery(configPeerDiscoveryModel)
                    .limits(configPeerLimitsModel).build();
            ...
            ConfigPeerChaincode configPeerChaincodeModel = new ConfigPeerChaincode.Builder()
                    ...
                    .installTimeout("300s").startuptimeout("300s").executetimeout("30s")
                    .system(configPeerChaincodeSystemModel).logging(configPeerChaincodeLoggingModel).build();
            ...
            CreatePeerBodyStorage createPeerBodyStorageModel = new CreatePeerBodyStorage.Builder()
                    .peer(storageObjectModel).statedb(storageObjectModel).build();
            Hsm hsmModel = new Hsm.Builder().pkcs11endpoint("tcp://example.com:666").build();

            CreatePeerOptions createPeerOptions = new CreatePeerOptions.Builder().mspId("Org1").displayName("My Peer")
    ...
    public void testImportPeer() throws Exception {
        try {
            ...
            ImportPeerOptions importPeerOptions = new ImportPeerOptions.Builder().displayName("My Peer")
                    .grpcwpUrl("https://n3a3ec3-mypeer-proxy.ibp.us-south.containers.appdomain.cloud:8084")
                    .msp(mspCryptoFieldModel).mspId("Org1")
                    .apiUrl("grpcs://n3a3ec3-mypeer.ibp.us-south.containers.appdomain.cloud:7051").location("ibmcloud")
    ...
    public void testEditPeer() throws Exception {
        try {
            EditPeerOptions editPeerOptions = new EditPeerOptions.Builder().id("testString").displayName("My Peer")
                    .apiUrl("grpcs://n3a3ec3-mypeer.ibp.us-south.containers.appdomain.cloud:7051")
                    .operationsUrl("https://n3a3ec3-mypeer.ibp.us-south.containers.appdomain.cloud:9443")
                    .grpcwpUrl("https://n3a3ec3-mypeer-proxy.ibp.us-south.containers.appdomain.cloud:8084")
                    .mspId("Org1").location("ibmcloud")
                    .tags(new java.util.ArrayList<String>(java.util.Arrays.asList("fabric-ca"))).build();
    ...
    public void testPeerAction() throws Exception {
        try {
            ...
            PeerActionOptions peerActionOptions = new PeerActionOptions.Builder().id("testString").restart(true)
    ...
    public void testUpdatePeer() throws Exception {
        try {
            ...
            ConfigPeerLimits configPeerLimitsModel = new ConfigPeerLimits.Builder()
                    .concurrency(configPeerLimitsConcurrencyModel).build();
            ConfigPeerUpdatePeer configPeerUpdatePeerModel = new ConfigPeerUpdatePeer.Builder().id("john-doe")
                    .networkId("dev").keepalive(configPeerKeepaliveModel).gossip(configPeerGossipModel)
                    .authentication(configPeerAuthenticationModel).client(configPeerClientModel)
                    .deliveryclient(configPeerDeliveryclientModel).adminService(configPeerAdminServiceModel)
                    .validatorPoolSize(Double.valueOf("8")).discovery(configPeerDiscoveryModel)
                    .limits(configPeerLimitsModel).build();
            ConfigPeerChaincodeGolang configPeerChaincodeGolangModel = new ConfigPeerChaincodeGolang.Builder()
            ...
            UpdateMspCryptoField updateMspCryptoFieldModel = new UpdateMspCryptoField.Builder()
                    .ca(updateMspCryptoFieldCaModel).tlsca(updateMspCryptoFieldTlscaModel)
                    .component(updateMspCryptoFieldComponentModel).build();
            ...
            UpdatePeerOptions updatePeerOptions = new UpdatePeerOptions.Builder().id("testString")
                    .adminCerts(new java.util.ArrayList<String>(java.util.Arrays.asList(
                            "LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCkNlcnQgZGF0YSB3b3VsZCBiZSBoZXJlIGlmIHRoaXMgd2FzIHJlYWwKLS0tLS1FTkQgQ0VSVElGSUNBVEUtLS0tLQo=")))
    ...
    public void testCreateOrderer() throws Exception {
        try {
            ...
            ConfigOrdererKeepalive configOrdererKeepaliveModel = new ConfigOrdererKeepalive.Builder()
                    .serverMinInterval("60s").serverInterval("2h").serverTimeout("20s").build();
            ...
            ConfigOrdererGeneral configOrdererGeneralModel = new ConfigOrdererGeneral.Builder()
                    .keepalive(configOrdererKeepaliveModel).bccsp(bccspModel)
                    .authentication(configOrdererAuthenticationModel).build();

            ConfigOrdererDebug configOrdererDebugModel = new ConfigOrdererDebug.Builder()
                    .broadcastTraceDir("testString").deliverTraceDir("testString").build();

            ConfigOrdererMetricsStatsd configOrdererMetricsStatsdModel = new ConfigOrdererMetricsStatsd.Builder()
                    .network("udp").address("127.0.0.1:8125").writeInterval("10s").prefix("server").build();
            ...
            ConfigOrdererCreate configOrdererCreateModel = new ConfigOrdererCreate.Builder()
                    .general(configOrdererGeneralModel).debug(configOrdererDebugModel)
                    .metrics(configOrdererMetricsModel).build();
            ...
            CreateOrdererOptions createOrdererOptions = new CreateOrdererOptions.Builder().ordererType("raft")
                    ...
                    .configOverride(new java.util.ArrayList<ConfigOrdererCreate>(
                            java.util.Arrays.asList(configOrdererCreateModel)))
                    ...
                    .tags(new java.util.ArrayList<String>(java.util.Arrays.asList("fabric-ca")))
                    .region(new java.util.ArrayList<String>(java.util.Arrays.asList("-"))).hsm(hsmModel)
    ...
    public void testImportOrderer() throws Exception {
        try {
            ...
            ImportOrdererOptions importOrdererOptions = new ImportOrdererOptions.Builder()
                    ...
                    .clusterId("testString").location("ibmcloud")
    ...
    public void testEditOrderer() throws Exception {
        try {
            EditOrdererOptions editOrdererOptions = new EditOrdererOptions.Builder().id("testString")
                    .clusterName("ordering service 1").displayName("orderer")
                    .apiUrl("grpcs://n3a3ec3-myorderer.ibp.us-south.containers.appdomain.cloud:7050")
                    .operationsUrl("https://n3a3ec3-myorderer.ibp.us-south.containers.appdomain.cloud:8443")
                    .grpcwpUrl("https://n3a3ec3-myorderer-proxy.ibp.us-south.containers.appdomain.cloud:443")
                    .mspId("Org1").consenterProposalFin(true).location("ibmcloud").systemChannelId("testchainid")
                    .tags(new java.util.ArrayList<String>(java.util.Arrays.asList("fabric-ca"))).build();
    ...
    public void testOrdererAction() throws Exception {
        try {
            ...
            OrdererActionOptions ordererActionOptions = new OrdererActionOptions.Builder().id("testString")
                    .restart(true).reenroll(actionReenrollModel).enroll(actionEnrollModel).build();
    ...
    public void testUpdateOrderer() throws Exception {
        try {
            ...
            ConfigOrdererUpdate configOrdererUpdateModel = new ConfigOrdererUpdate.Builder()
                    .general(configOrdererGeneralUpdateModel).debug(configOrdererDebugModel)
                    .metrics(configOrdererMetricsModel).build();
            ...
            UpdateOrdererOptions updateOrdererOptions = new UpdateOrdererOptions.Builder().id("testString")
                    .adminCerts(new java.util.ArrayList<String>(java.util.Arrays.asList(
                            "LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCkNlcnQgZGF0YSB3b3VsZCBiZSBoZXJlIGlmIHRoaXMgd2FzIHJlYWwKLS0tLS1FTkQgQ0VSVElGSUNBVEUtLS0tLQo=")))
                    .configOverride(configOrdererUpdateModel).crypto(updateOrdererBodyCryptoModel).nodeOu(nodeOuModel)
                    .replicas(Double.valueOf("1")).resources(updateOrdererBodyResourcesModel).version("1.4.6-1")
                    .zone("-").build();
    ...
    public void testSubmitBlock() throws Exception {
        try {
            SubmitBlockOptions submitBlockOptions = new SubmitBlockOptions.Builder().id("testString").b64Block(
    ...
    public void testImportMsp() throws Exception {
        try {
            ImportMspOptions importMspOptions = new ImportMspOptions.Builder().mspId("Org1").displayName("My Peer")
                    .rootCerts(new java.util.ArrayList<String>(java.util.Arrays.asList(
                            "LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCkNlcnQgZGF0YSB3b3VsZCBiZSBoZXJlIGlmIHRoaXMgd2FzIHJlYWwKLS0tLS1FTkQgQ0VSVElGSUNBVEUtLS0tLQo=")))
    ...
    public void testEditMsp() throws Exception {
        try {
            EditMspOptions editMspOptions = new EditMspOptions.Builder().id("testString").mspId("Org1")
                    .displayName("My Peer")
                    .rootCerts(new java.util.ArrayList<String>(java.util.Arrays.asList(
                            "LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCkNlcnQgZGF0YSB3b3VsZCBiZSBoZXJlIGlmIHRoaXMgd2FzIHJlYWwKLS0tLS1FTkQgQ0VSVElGSUNBVEUtLS0tLQo=")))
                    .intermediateCerts(new java.util.ArrayList<String>(java.util.Arrays.asList(
    ...
    public void testGetMspCertificate() throws Exception {
        try {
            GetMspCertificateOptions getMspCertificateOptions = new GetMspCertificateOptions.Builder()
                    .mspId("testString").cache("skip").build();

            // Invoke operation
            Response<GetMSPCertificateResponse> response = service.getMspCertificate(getMspCertificateOptions)
                    .execute();
            // Validate response
            assertNotNull(response);
            assertEquals(response.getStatusCode(), 200);
    ...
    public void testEditAdminCerts() throws Exception {
        try {
            EditAdminCertsOptions editAdminCertsOptions = new EditAdminCertsOptions.Builder().id("testString")
    ...
    public void testGetComponentsByType() throws Exception {
        try {
            GetComponentsByTypeOptions getComponentsByTypeOptions = new GetComponentsByTypeOptions.Builder()
                    .componentType("fabric-peer").deploymentAttrs("included").parsedCerts("included").cache("skip")
                    .build();

            // Invoke operation
            Response<GetMultiComponentsResponse> response = service.getComponentsByType(getComponentsByTypeOptions)
                    .execute();
            // Validate response
            assertNotNull(response);
            assertEquals(response.getStatusCode(), 200);
    ...
    public void testGetComponentsByTag() throws Exception {
        try {
            GetComponentsByTagOptions getComponentsByTagOptions = new GetComponentsByTagOptions.Builder()
                    .tag("testString").deploymentAttrs("included").parsedCerts("included").cache("skip").build();

            // Invoke operation
            Response<GetMultiComponentsResponse> response = service.getComponentsByTag(getComponentsByTagOptions)
                    .execute();
            // Validate response
            assertNotNull(response);
            assertEquals(response.getStatusCode(), 200);
    ...
    public void testEditSettings() throws Exception {
        try {
            ...
            LoggingSettingsClient loggingSettingsClientModel = new LoggingSettingsClient.Builder().enabled(true)
                    .level("silly").uniqueName(false).build();

            LoggingSettingsServer loggingSettingsServerModel = new LoggingSettingsServer.Builder().enabled(true)
                    .level("silly").uniqueName(false).build();

            EditLogSettingsBody editLogSettingsBodyModel = new EditLogSettingsBody.Builder()
                    .client(loggingSettingsClientModel).server(loggingSettingsServerModel).build();
            ...
            EditSettingsOptions editSettingsOptions = new EditSettingsOptions.Builder()
                    ...
                    .fabricLcGetCcTimeoutMs(Double.valueOf("180000")).fabricGeneralTimeoutMs(Double.valueOf("10000"))
                    .build();
    ...
    public void testGetFabVersions() throws Exception {
        try {
            GetFabVersionsOptions getFabVersionsOptions = new GetFabVersionsOptions.Builder().cache("skip").build();
    ...
    public void testArchiveNotifications() throws Exception {
        try {
            ArchiveNotificationsOptions archiveNotificationsOptions = new ArchiveNotificationsOptions.Builder()
                    .notificationIds(new java.util.ArrayList<String>(
                            java.util.Arrays.asList("c9d00ebf849051e4f102008dc0be2488")))
                    .build();
    ...
    public void testGetPostman() throws Exception {
        try {
            GetPostmanOptions getPostmanOptions = new GetPostmanOptions.Builder().authType("bearer").token("testString")
    ...
    public void testRemoveComponentsByTag() throws Exception {
        try {
            ...
            // Invoke operation
            Response<RemoveMultiComponentsResponse> response = service
                    .removeComponentsByTag(removeComponentsByTagOptions).execute();
            // Validate response
            assertNotNull(response);
            assertEquals(response.getStatusCode(), 200);
    ...
    public void testRemoveComponent() throws Exception {
        try {
            RemoveComponentOptions removeComponentOptions = new RemoveComponentOptions.Builder().id("testString")
                    .build();
    ...
    public void testDeleteSigTx() throws Exception {
        try {
            DeleteSigTxOptions deleteSigTxOptions = new DeleteSigTxOptions.Builder().id("testString").build();
    ...
    public void testDeleteComponentsByTag() throws Exception {
        try {
            ...
            // Invoke operation
            Response<DeleteMultiComponentsResponse> response = service
                    .deleteComponentsByTag(deleteComponentsByTagOptions).execute();
            // Validate response
            assertNotNull(response);
            assertEquals(response.getStatusCode(), 200);
    ...
    public void testDeleteComponent() throws Exception {
        try {
            DeleteComponentOptions deleteComponentOptions = new DeleteComponentOptions.Builder().id("testString")
                    .build();
    ...
    public void testDeleteAllSessions() throws Exception {
        try {
            ...
            // Invoke operation
            Response<DeleteAllSessionsResponse> response = service.deleteAllSessions(deleteAllSessionsOptions)
                    .execute();
            // Validate response
            assertNotNull(response);
            assertEquals(response.getStatusCode(), 200);
    ...
    public void testDeleteAllNotifications() throws Exception {
        try {
            ...
            // Invoke operation
            Response<DeleteAllNotificationsResponse> response = service
                    .deleteAllNotifications(deleteAllNotificationsOptions).execute();
            // Validate response
            assertNotNull(response);
            assertEquals(response.getStatusCode(), 200);
    ...
    public void testDeleteAllComponents() throws Exception {
        try {
            ...
            // Invoke operation
            Response<DeleteMultiComponentsResponse> response = service.deleteAllComponents(deleteAllComponentsOptions)
                    .execute();
            // Validate response
            assertNotNull(response);
            assertEquals(response.getStatusCode(), 200);
