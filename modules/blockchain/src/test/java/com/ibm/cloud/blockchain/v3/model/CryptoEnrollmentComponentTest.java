...
/**
 * Unit test class for the CryptoEnrollmentComponent model.
 */
public class CryptoEnrollmentComponentTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCryptoEnrollmentComponent() throws Throwable {
    ...
    String json = TestUtilities.serialize(cryptoEnrollmentComponentModel);

    CryptoEnrollmentComponent cryptoEnrollmentComponentModelNew = TestUtilities.deserialize(json, CryptoEnrollmentComponent.class);
    assertTrue(cryptoEnrollmentComponentModelNew instanceof CryptoEnrollmentComponent);
  }
}