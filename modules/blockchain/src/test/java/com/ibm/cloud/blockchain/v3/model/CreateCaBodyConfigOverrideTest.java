...
/**
 * Unit test class for the CreateCaBodyConfigOverride model.
 */
public class CreateCaBodyConfigOverrideTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateCaBodyConfigOverride() throws Throwable {
    ...
    String json = TestUtilities.serialize(createCaBodyConfigOverrideModel);

    CreateCaBodyConfigOverride createCaBodyConfigOverrideModelNew = TestUtilities.deserialize(json, CreateCaBodyConfigOverride.class);
    assertTrue(createCaBodyConfigOverrideModelNew instanceof CreateCaBodyConfigOverride);
    assertEquals(createCaBodyConfigOverrideModelNew.ca().toString(), configCaCreateModel.toString());
    assertEquals(createCaBodyConfigOverrideModelNew.tlsca().toString(), configCaCreateModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateCaBodyConfigOverrideError() throws Throwable {
    new CreateCaBodyConfigOverride.Builder().build();
  }
