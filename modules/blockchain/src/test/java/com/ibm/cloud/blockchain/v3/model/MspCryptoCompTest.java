...
/**
 * Unit test class for the MspCryptoComp model.
 */
public class MspCryptoCompTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testMspCryptoComp() throws Throwable {
    ...
    String json = TestUtilities.serialize(mspCryptoCompModel);

    MspCryptoComp mspCryptoCompModelNew = TestUtilities.deserialize(json, MspCryptoComp.class);
    assertTrue(mspCryptoCompModelNew instanceof MspCryptoComp);
    assertEquals(mspCryptoCompModelNew.ekey(), "testString");
    assertEquals(mspCryptoCompModelNew.ecert(), "LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCkNlcnQgZGF0YSB3b3VsZCBiZSBoZXJlIGlmIHRoaXMgd2FzIHJlYWwKLS0tLS1FTkQgQ0VSVElGSUNBVEUtLS0tLQo=");
    assertEquals(mspCryptoCompModelNew.tlsKey(), "testString");
    assertEquals(mspCryptoCompModelNew.tlsCert(), "LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCkNlcnQgZGF0YSB3b3VsZCBiZSBoZXJlIGlmIHRoaXMgd2FzIHJlYWwKLS0tLS1FTkQgQ0VSVElGSUNBVEUtLS0tLQo=");
    assertEquals(mspCryptoCompModelNew.clientAuth().toString(), clientAuthModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testMspCryptoCompError() throws Throwable {
    new MspCryptoComp.Builder().build();
  }
