...
/**
 * Unit test class for the MspCryptoCa model.
 */
public class MspCryptoCaTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testMspCryptoCa() throws Throwable {
    ...
    String json = TestUtilities.serialize(mspCryptoCaModel);

    MspCryptoCa mspCryptoCaModelNew = TestUtilities.deserialize(json, MspCryptoCa.class);
    assertTrue(mspCryptoCaModelNew instanceof MspCryptoCa);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testMspCryptoCaError() throws Throwable {
    new MspCryptoCa.Builder().build();
  }
