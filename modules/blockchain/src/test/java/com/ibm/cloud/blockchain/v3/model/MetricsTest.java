...
public class MetricsTest {
  ...
  public void testMetrics() throws Throwable {
    ...
    String json = TestUtilities.serialize(metricsModel);

    Metrics metricsModelNew = TestUtilities.deserialize(json, Metrics.class);
    assertTrue(metricsModelNew instanceof Metrics);
    assertEquals(metricsModelNew.provider(), "prometheus");
    assertEquals(metricsModelNew.statsd().toString(), metricsStatsdModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testMetricsError() throws Throwable {
    new Metrics.Builder().build();
  }
