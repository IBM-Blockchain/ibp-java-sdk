...
/**
 * Unit test class for the GetComponentsByTypeOptions model.
 */
public class GetComponentsByTypeOptionsTest {
  ...
  public void testGetComponentsByTypeOptionsError() throws Throwable {
    new GetComponentsByTypeOptions.Builder().build();
  }
