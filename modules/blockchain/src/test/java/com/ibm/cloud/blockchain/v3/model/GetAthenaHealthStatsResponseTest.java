...
/**
 * Unit test class for the GetAthenaHealthStatsResponse model.
 */
public class GetAthenaHealthStatsResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetAthenaHealthStatsResponse() throws Throwable {
    GetAthenaHealthStatsResponse getAthenaHealthStatsResponseModel = new GetAthenaHealthStatsResponse();
    assertNull(getAthenaHealthStatsResponseModel.getOptools());
    assertNull(getAthenaHealthStatsResponseModel.getOs());
  }
}