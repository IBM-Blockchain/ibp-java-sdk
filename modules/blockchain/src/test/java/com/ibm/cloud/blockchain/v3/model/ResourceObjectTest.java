...
/**
 * Unit test class for the ResourceObject model.
 */
public class ResourceObjectTest {
  ...
  @Test
  public void testResourceObject() throws Throwable {
    ...
    String json = TestUtilities.serialize(resourceObjectModel);

    ResourceObject resourceObjectModelNew = TestUtilities.deserialize(json, ResourceObject.class);
    assertTrue(resourceObjectModelNew instanceof ResourceObject);
    assertEquals(resourceObjectModelNew.requests().toString(), resourceRequestsModel.toString());
    assertEquals(resourceObjectModelNew.limits().toString(), resourceLimitsModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testResourceObjectError() throws Throwable {
    new ResourceObject.Builder().build();
  }
