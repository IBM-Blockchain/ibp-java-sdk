...
/**
 * Unit test class for the UpdateCaBodyConfigOverride model.
 */
public class UpdateCaBodyConfigOverrideTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateCaBodyConfigOverride() throws Throwable {
    ...
    UpdateCaBodyConfigOverride updateCaBodyConfigOverrideModel = new UpdateCaBodyConfigOverride.Builder()
      ...
      .build();
    assertEquals(updateCaBodyConfigOverrideModel.ca(), configCaUpdateModel);

    String json = TestUtilities.serialize(updateCaBodyConfigOverrideModel);

    UpdateCaBodyConfigOverride updateCaBodyConfigOverrideModelNew = TestUtilities.deserialize(json, UpdateCaBodyConfigOverride.class);
    assertTrue(updateCaBodyConfigOverrideModelNew instanceof UpdateCaBodyConfigOverride);
    assertEquals(updateCaBodyConfigOverrideModelNew.ca().toString(), configCaUpdateModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateCaBodyConfigOverrideError() throws Throwable {
    new UpdateCaBodyConfigOverride.Builder().build();
  }
