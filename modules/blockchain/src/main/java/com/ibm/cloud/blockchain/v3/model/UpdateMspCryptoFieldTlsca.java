 ...
 */
public class UpdateMspCryptoFieldTlsca extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(UpdateMspCryptoFieldTlsca updateMspCryptoFieldTlsca) {
      this.rootCerts = updateMspCryptoFieldTlsca.rootCerts;
      this.caIntermediateCerts = updateMspCryptoFieldTlsca.caIntermediateCerts;
    }
    ...
    /**
     * Builds a UpdateMspCryptoFieldTlsca.
     *
     * @return the new UpdateMspCryptoFieldTlsca instance
     */
    public UpdateMspCryptoFieldTlsca build() {
      return new UpdateMspCryptoFieldTlsca(this);
    }
     ...
     * @return the UpdateMspCryptoFieldTlsca builder
     */
  ...
  protected UpdateMspCryptoFieldTlsca(Builder builder) {
   ...
   * New builder.
   *
   * @return a UpdateMspCryptoFieldTlsca builder
   */
