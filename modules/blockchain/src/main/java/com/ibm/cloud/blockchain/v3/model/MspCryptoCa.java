 ...
 * MspCryptoCa.
 */
public class MspCryptoCa extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(MspCryptoCa mspCryptoCa) {
      this.rootCerts = mspCryptoCa.rootCerts;
      this.caIntermediateCerts = mspCryptoCa.caIntermediateCerts;
    }
    ...
    /**
     * Builds a MspCryptoCa.
     *
     * @return the new MspCryptoCa instance
     */
    public MspCryptoCa build() {
      return new MspCryptoCa(this);
    }
     ...
     * @return the MspCryptoCa builder
     */
  ...
  protected MspCryptoCa(Builder builder) {
