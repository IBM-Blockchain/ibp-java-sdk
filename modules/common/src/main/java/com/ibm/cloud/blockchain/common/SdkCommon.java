...
// >>> Replace "blockchain" with the correct value for your project
package com.ibm.cloud.blockchain.common;
...
public class SdkCommon {
    ...
    // >>> Replace "blockchain" with the parent project's artifactId (e.g. platform-services)
    private static String parentArtifactId = "blockchain";
